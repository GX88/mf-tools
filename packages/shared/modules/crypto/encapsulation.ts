...
export const rabbitEncode = (val: string, key: string, iv?: string) =>
  rabbit.encode({ src: val, key, iv })
export const rabbitDecode = (val: string, key: string, iv?: string) =>
  rabbit.decode({ src: val, key, iv })

export const rabbitLegacyEncode = (val: string, key: string, iv?: string) =>
  rabbitLegacy.encode({ src: val, key, iv })
export const rabbitLegacyDecode = (val: string, key: string, iv?: string) =>
  rabbitLegacy.decode({ src: val, key, iv })
