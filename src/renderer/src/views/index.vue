    ...
    <FaPageHeader>
      ...
      <template #description>
        <div class="text-sm/6">
          <div>
            这是一款<b
              class="text-emphasis">开箱即用</b>的中后台框架，同时它也经历过数十个真实项目的技术沉淀，确保框架在开发中可落地、可使用、可维护
          </div>
          <div>
      ...
      <div class="flex gap-2">
        <FaButton variant="outline"
          @click="open('https://fantastic-admin.hurui.me')">
    ...
    <div class="w-full flex flex-col gap-4 px-4 xl-flex-row">
      <FaPageMain class="m-0 flex-1"
        ...
        <ul class="m-0 list-disc px-8 text-sm leading-6 space-y-1">
          <li v-for="item in fantasticStartkitInfo.feature"
            :key="item">
            {{ item }}
          </li>
        </ul>
      ...
      <FaPageMain class="m-0 flex-1"
        ...
        <div class="size-full flex items-center justify-center px-12">
          <FaCarousel :autoplay="{
            ...
            <img v-for="item in fantasticAdminInfo.data" :key="item"
              v-zoomable :src="item"
              class="size-full cursor-pointer overflow-hidden border rounded-xl object-cover">
          </FaCarousel>
        </div>
      </FaPageMain>
      <FaPageMain class="m-0 flex-1"
        ...
        <template #title>
          ...
          <div class="ms-auto">
            <FaButton
              @click="open('https://one-step-admin.hurui.me')">
              访问官网
            </FaButton>
          </div>
        </template>
        <div class="size-full flex items-center justify-center px-12">
          <FaCarousel :autoplay="{
            ...
            <img v-for="item in oneStepAdminInfo.data" :key="item"
              v-zoomable :src="item"
              class="size-full cursor-pointer overflow-hidden border rounded-xl object-cover">
          </FaCarousel>
        </div>
