...
<template>
  <div class="tabbar">
    ...
    <div class="tabbar-container">
      <FaScrollArea
        ref="tabsRef" :scrollbar="false" mask horizontal
        gradient-color="var(--g-tabbar-bg)" class="tabs" :class="{
        ...
        <TransitionGroup ref="tabContainerRef"
          :name="!isDragging ? 'tabbar' : undefined" tag="div"
          ...
          <div
            ...
            :key="element.tabMerge === 'routeName' && element.routeName ? element.routeName : element.tabId"
              ...
              <div class="size-full">
                ...
                <FaTooltip :delay="1000" side="bottom">
                  <div class="tab-content">
                    ...
                    <div v-if="!element.isPermanent && element.isPin"
                      class="action-icon"
                    ...
                    <div
                      v-show="keys.alt && getVisibleTabIndex(index) >= 0 && getVisibleTabIndex(index) < 9"
                      class="hotkey-number">
      ...
      <div
        class="flex-center flex-shrink-0 gap-2 whitespace-nowrap p-2">
