    ...
    <div
      ...
      <FaScrollArea :scrollbar="false" mask
          ...
          <template v-for="(item, index) in menuStore.allMenus"
            ...
            <div
              ...
              <div
                ...
                class="group menu-item-container relative h-full w-full flex cursor-pointer items-center justify-between gap-1 rounded-lg py-4 text-[var(--g-main-sidebar-menu-color)] transition-colors hover-(bg-[var(--g-main-sidebar-menu-hover-bg)] text-[var(--g-main-sidebar-menu-hover-color)]) px-2!"
                :class="{
        ...
        <Menu
          ...
          show-collapse-name
          collapse :dark="settingsStore.settings.menu.enableDark"
