  ...
  <Transition name="header">
    <header
      ...
      <div class="header-container">
        ...
        <FaScrollArea :scrollbar="false" mask horizontal
          ...
          <div
            ...
            class="menu h-full flex of-hidden transition-all" :class="{
            ...
            <template v-for="(item, index) in menuStore.allMenus"
              ...
              <div
                ...
                <div
                  ...
                  class="group menu-item-container relative h-full w-full flex cursor-pointer items-center justify-between gap-1 rounded-lg px-3 text-[var(--g-header-menu-color)] transition-colors hover-(bg-[var(--g-header-menu-hover-bg)] text-[var(--g-header-menu-hover-color)])"
                  :class="{
        ...
        <div class="flex-center">
          <AccountButton only-avatar dropdown-side="bottom"
            class="size-12 p-2" />
        </div>
