  ...
  <Transition name="header">
    <header
      v-if="
        settingsStore.mode === 'pc'
          && ['head', 'only-head', 'head-panel'].includes(
    ...
    >
      <div class="header-container">
        ...
        <Logo class="title" :show-title="false" />
        ...
        <FaScrollArea
          ...
          class="menu-container h-full flex-1 overscroll-contain"
        >
          <!-- 顶部模式 -->
          <div
            v-if="settingsStore.settings.menu.mode === 'head'"
            class="menu h-full flex of-hidden transition-all"
            :class="{
              [`menu-active-${settingsStore.settings.menu.style}`]:
                settingsStore.settings.menu.style !== '',
            }"
          >
            <template v-for="(item, index) in menuStore.allMenus" :key="index">
              ...
              >
                <div
                  ...
                  class="group menu-item-container text---g-header-menu-color relative h-full w-full flex cursor-pointer items-center justify-between gap-1 rounded-lg px-3 transition-colors hover-(bg-[var(--g-header-menu-hover-bg)] text-[var(--g-header-menu-hover-color)])"
                  :class="{
                    'text-(--g-header-menu-active-color)! bg-(--g-header-menu-active-bg)!':
                ...
                >
                  ...
                  <FaBadge
                    ...
                    "
                    :variant="
                      typeof item.meta.badgeVariant === 'function'
                        ? item.meta.badgeVariant()
                        : item.meta.badgeVariant
                    "
                    class="absolute inset-e-2 inset-t-2"
                  />
                </div>
              </div>
            </template>
          ...
          <Menu
            ...
            show-collapse-name
            collapse
            :dark="settingsStore.settings.menu.enableDark"
