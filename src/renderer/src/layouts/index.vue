...
<template>
  <div
    ...
    <div id="app-main"
      ...
      <Header
        :class="{ dark: settingsStore.settings.menu.enableDark }" />
      <div class="wrapper">
        <div class="sidebar-container"
          ...
          <MainSidebar
            :class="{ dark: settingsStore.settings.menu.enableDark }" />
          <SubSidebar :is-hover="isHoverSidebar"
            :class="{ dark: settingsStore.settings.menu.enableDark }" />
        </div>
        <div
          class="invisible fixed inset-0 z-1009 bg-black/50 op-0 backdrop-blur-sm transition-opacity"
          :class="{ 'op-100! visible!': settingsStore.mode === 'mobile' && !settingsStore.settings.menu.subMenuCollapse }"
          @click="settingsStore.toggleSidebarCollapse()" />
        <div
          class="main-container pb-(--g-main-container-padding-bottom)">
          <Topbar />
          <div id="app-content" class="main">
            <div v-show="settingsStore.mainPageMaximizeStatus"
            ...
            <RouterView v-slot="{ Component, route }">
              <Transition
                :name="(settingsStore.settings.mainPage.enableTransition && !settingsStore.isReloading) ? settingsStore.settings.mainPage.transitionMode : ''"
                mode="out-in">
    ...
    <Preferences
      v-if="settingsStore.settings.userPreferences.enable" />
    <HotkeysIntro />
