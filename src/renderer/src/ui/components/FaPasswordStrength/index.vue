        ...
        <div class="py-1">
          ...
          <ul class="text-sm text-muted-foreground space-y-1">
            <li
              ...
              :class="{ 'text-green-600': hasLength }"
            >
              <FaIcon
                :name="hasLength ? 'i-carbon:checkmark' : 'i-carbon:close'"
              />
              {{ t("hasLength") }}
            </li>
            <li
            ...
            >
              <FaIcon
                :name="hasUppercase ? 'i-carbon:checkmark' : 'i-carbon:close'"
              />
              {{ t("hasUppercase") }}
            </li>
            <li
            ...
            >
              <FaIcon
                :name="hasLowercase ? 'i-carbon:checkmark' : 'i-carbon:close'"
              />
              {{ t("hasLowercase") }}
            </li>
            <li
            ...
            >
              <FaIcon
                :name="hasNumber ? 'i-carbon:checkmark' : 'i-carbon:close'"
              />
              {{ t("hasNumber") }}
            </li>
            <li
            ...
            >
              <FaIcon
                :name="hasSpecialChar ? 'i-carbon:checkmark' : 'i-carbon:close'"
              />
              {{ t("hasSpecialChar") }}
            </li>
          </ul>
