...
<template>
  <div
    :class="cn('group/flipcard h-72 w-56 [perspective:1000px]', props.class)">
    <div
      :class="cn(
      ...
      <!-- 正面 -->
      <div
        class="[backface-visibility:hidden] absolute size-full overflow-hidden border rounded-2xl bg-card">
        <slot />
      </div>
      <!-- 背面 -->
      <div
