  ...
  <div
    ...
    <div
      ...
      <div v-if="hasChildren"
        class="absolute h-4 w-4 flex flex-shrink-0 items-center justify-center -inset-s-6"
      ...
      <FaCheckbox v-if="checkable" v-model="getCheckState"
        :disabled="node.disabled" class="flex-shrink-0" @click.stop />
    ...
    <!-- 子项目 -->
    <FaCollapsible v-if="hasChildren" :model-value="isOpen"
      ...
      <FaTreeNode
        ...
        <template
          #default="{ node: slotNode, expanded: slotExpanded }">
