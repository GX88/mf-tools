...
<template>
  <FaCard :class="cn('w-full', props.class)" header-class="pb-2"
    footer-class="flex flex-col items-start gap-y-1">
    <template #header>
      <div
        class="flex flex-row items-center justify-between gap-y-1.5 space-y-0">
        <h3
          class="flex-center-start gap-x-1 text-sm font-medium tracking-tight">
          {{ title }}
          <FaTooltip v-if="!!titleTips" :text="titleTips">
            <FaIcon name="i-material-symbols:help-rounded"
