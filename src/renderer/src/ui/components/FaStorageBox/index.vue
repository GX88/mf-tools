...
function onBeforeClose(action: string, done: () => void) {
  if (action === 'confirm') {
    ...
    else if (list.value.some(item => item.title === dialog.value.name)) {
...
function updateStorage() {
  const storageBoxData = localStorage.has('storageBoxData')
    ? JSON.parse(localStorage.getItem('storageBoxData') as string)
    : {}
