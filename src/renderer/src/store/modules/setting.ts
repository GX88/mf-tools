import type { IStoreSetting } from '@renderer/src/config/setting'
import type { IThemeWithoutSystem } from '@shared/config/theme'
import type { ILangWithoutSystem } from '@shared/locales'
import type { PiniaPluginContext } from 'pinia'
import SYSTEM_CONFIG from '@renderer/src/config/setting'
import i18n, { langCode } from '@renderer/src/locales'
